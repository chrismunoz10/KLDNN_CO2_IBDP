...
nx, ny, nz, nt = [126, 125, 110, 50]
Nxy = nx * ny * nz
Nxyz = Nxy

p_1_mean = np.load(f'Pressure/p_mean_NR{NR}.npy')
...
p_test_pred =  np.reshape(np.transpose(p_test_pred, (0, 2, 1)), (test_size, nx, ny, nz, nt)) 